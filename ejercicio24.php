...
class Trabajador extends Persona{
    ...
    public function presentarseComoTrabajador(){
        echo "hola soy ".$this->puesto;
    }

}

$primerTrabajador = new Trabajador();
$primerTrabajador->asignarNombre("Arturito");
$primerTrabajador->puesto="Profesor";

$primerTrabajador->presentarseComoTrabajador();
